...
#config_file = "~/Best-Partition-MaF1-ECC/bpma-ecc-config-files/jaccard/j-bpma-GpositiveGO.csv"
...
cat("\n# EXECUTE                                                          #")
cat("\n####################################################################\n\n")
timeFinal <- system.time(results <- executaBPMA(ds,
                                               dataset_name,
                                               number_dataset,
                                               number_cores,
                                               number_folds,
...
str_a <- paste("tar -zcf ", diretorios$folderResults, "/", dataset_name,
               "-", similarity, "-results-bpmi-e.tar.gz ",
...
str_b <- paste("cp -r ", diretorios$folderResults, "/", dataset_name,
               "-", similarity, "-results-bpmi-e.tar.gz ", folder, sep = "")
print(system(str_b))
