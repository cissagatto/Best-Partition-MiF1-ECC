...
## How to cite 
@misc{Gatto2021, author = {Gatto, E. C.}, title = {Select Best Partition with Micro-F1 and ECC}, year = {2021}, publisher = {GitHub}, journal = {GitHub repository}, howpublished = {\url{https://github.com/cissagatto/Best-Partition-MiF1-ECC}}}
...
## RUN
To run the code, open the terminal, enter the *~/Best-Partition-MiF1-ECC/R* folder, and type

```
Rscript microf1.R [absolute_path_to_config_file]
```

Example:

```
Rscript microf1.R "~/Best-Partition-MiF1-ECC/bpmi-ecc-Config-Files/jaccard/j-bpmi-GpositiveGO.csv"
```
